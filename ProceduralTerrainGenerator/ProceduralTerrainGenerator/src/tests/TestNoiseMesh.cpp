...
namespace test
{
		...
		deltaTime(0.0f), lastFrame(0.0f), camera(800, 600), lightSource()
	{
		...
		utilities::benchmark_void(utilities::CreateTerrainMesh, "CreateTerrainMesh", mesh, meshIndices, width, height, scale, octaves, constrast, noise::Options::REVERT_NEGATIVES, true, true);
